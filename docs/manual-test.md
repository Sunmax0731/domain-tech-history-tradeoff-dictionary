...
`D:\AI\Dictionary\domain-tech-history-tradeoff-dictionary`
...
- `public/index.html`
- `dist/domain-tech-history-tradeoff-dictionary-docs.zip`

## セットアップ手順

```powershell
cd D:\AI\Dictionary\domain-tech-history-tradeoff-dictionary
npm test
npm start
```
...
4. `dist/domain-tech-history-tradeoff-dictionary-docs.zip` を展開し、README、導入手順、ユーザーガイド、QCDS、release evidence が含まれることを確認する。
